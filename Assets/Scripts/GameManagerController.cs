...
public class GameManagerController : MonoBehaviour
{
    ...
    void TransitionToANextStageOfLife(SpaceObject.TypeStar type) //Переход на новую стадию жизни звезды
    {
    ...
    void TransitionToABackStageOfLife(SpaceObject.TypeStar type) //Переход на предыдущую стадию жизни звезды
    {
